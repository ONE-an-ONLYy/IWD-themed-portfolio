$(function(){
	...
	$('#contact-form').validator().on('submit', function (e) {
		if (e.isDefaultPrevented()) {
		  ...
		  // Form validation success, you can choose to perform additional client-side logic here if needed.
		  // The form will be submitted to the specified "action" URL automatically.
		}
	  });
